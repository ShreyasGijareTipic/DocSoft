...
//     {
//         try {
//             // Get the incoming message and the phone number of the sender
//             $incomingMessage = $request->input('message');
//             $phoneNumber = $request->input('phone_number');

//             if (!$incomingMessage || !$phoneNumber) {
//                 return response()->json(['error' => 'Message and phone number are required'], 400);
//             }

//             // Respond based on the message
//             if (strtolower($incomingMessage) === 'hi') {
//                 return $this->sendMessage($phoneNumber, 'Welcome to our project!');
//             }

//             // Handle other messages or default message
//             return $this->sendMessage($phoneNumber, 'I am sorry, I did not understand that.');
//         } catch (\Exception $e) {
//             return response()->json(['error' => $e->getMessage()], 500);
//         }
//     }
...
//         $response = $client->post('https://graph.facebook.com/v21.0/482346864961658/messages', [
//             'headers' => [
//                 'Authorization' => 'Bearer EAAXDOdIVS2ABO0pcYo6OZCMESZCtXJZCnnj7zIcBQTJNCwjT5i1JBtmH0WxcEbLmLnElrepsRGZBT9thPqkLF4SYWk0I4I9GupWz30ZBSYoxNZCAYNWxByBZCv2f4JNgE5cUZBl9dAgoRlJuMtE4bZABGn6cPZAiUG2vMVOap1myLd24sZBhro9CwDeoZBZBGgSIasvpr5QZDZD', // Replace with your actual token
//                 'Content-Type' => 'application/json',
//             ],
//             'json' => [
//                 'messaging_product' => 'whatsapp',
